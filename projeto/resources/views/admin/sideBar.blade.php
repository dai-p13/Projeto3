<div class="bg-light border-right" id="sidebar-wrapper" style="height=100%">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="profsFaculdade" class="list-group-item list-group-item-action bg-light">Gerir Professores de Faculdades</a>
        <a href="concelhos" class="list-group-item list-group-item-action bg-light">Gerir Concelhos</a>
      </div>
</div>
