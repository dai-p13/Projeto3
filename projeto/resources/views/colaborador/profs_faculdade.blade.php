...
<head>
    ...
    <title>Gerir Professores de Faculdade</title>
                    ...
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h2>Gerir <b>Professores de Faculdade</b></h2>
                                    </div>
                                    <div class="col-sm-6">
                                        <a href="#add" class="btn btn-success" data-toggle="modal"><i
                                            class="material-icons">&#xE147;</i> <span>Criar um novo Professor de Faculdade</span></a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <?php
                                        if(isset($data)) {
                                            foreach($data as $linha) {
                                                $dados = '<tr>';
                                                $dados = $dados.'<td>'.$linha->id_professorFaculdade.'</td>';
                                                $dados = $dados.'<td>'.$linha->nome.'</td>';
                                                $dados = $dados.'<td>'.$linha->cargo.'</td>';
                ...
                <div id="add" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form method="POST" action="profsFaculdade/add">
                                @csrf
                                <div class="modal-header">
                                    <h4 class="modal-title">Adicionar Professor de Faculadade</h4>
...
<script src="{{ asset('js/colaborador/pagProfsFacul.js') }}"></script>
</html>